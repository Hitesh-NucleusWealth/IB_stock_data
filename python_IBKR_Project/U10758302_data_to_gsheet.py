...
class TestApp(EWrapper, EClient):
    ...
    def start(self):
        ...
        self.reqAccountUpdates(True, "U10758302") # <----- Change account number here "U6084453"

    def stop(self):
        self.reqAccountUpdates(False,"U10758302") # <----- Change account number here "U6084453"
        self.done = True
        self.disconnect()
...
def main():
    ...
    spreadsheet_id = '1wRpKjwTwDoYLMYGTRLXG7_ItU5ozwJN4SGTZpIW_AKo' # consolidated spreadsheet ID
        ...
        #'1FFcubMEYL89gceu3uHXx95MNU7hjPG2PgeDXQyk3vfY' - individual spreadsheet id
    ...
    wk_sheet_stock = gc.open('Howard Hedge Fund Account').worksheet_by_title('U10758302_stock')
    ...
    if len(cells) < 2:
        ...
        gc.sheet.values_append(spreadsheet_id, stock_df_values, "ROWS", "U10758302_stock")
        gc.sheet.values_append(spreadsheet_id, currency_df_values, "ROWS", "U10758302_currency")
