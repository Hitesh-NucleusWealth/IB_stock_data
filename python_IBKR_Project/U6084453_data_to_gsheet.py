...
class TestApp(EWrapper, EClient):
    ...
    def start(self):
        ...
        self.reqAccountUpdates(True, "U6084453") # <----- Change account number here "U6084453"

    def stop(self):
        self.reqAccountUpdates(False,"U6084453") # <----- Change account number here "U6084453"
        self.done = True
        self.disconnect()
...
def main():
    ...
    spreadsheet_id = '1YQ_rJCYNtwqusUCVA9vRu7rUGklMqA1BcWQJtGdxV1E'
    ...
    wk_sheet_stock = gc.open('U6084453_ib_data').sheet1
