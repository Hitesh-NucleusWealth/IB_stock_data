...
class TestApp(EWrapper, EClient):
    ...
    def start(self):
        ...
        self.reqAccountUpdates(True, "U9426503") # <----- Change account number here "U6084453"

    def stop(self):
        self.reqAccountUpdates(False,"U9426503") # <----- Change account number here "U6084453"
        self.done = True
        self.disconnect()
...
def main():
    ...
    spreadsheet_id = '1wRpKjwTwDoYLMYGTRLXG7_ItU5ozwJN4SGTZpIW_AKo' # consolidated spreadsheet ID
        ...
        #'1-0zp4Kvjk2PtYOUavAFdgAov3I0HeO79yx9QxM015-0' - individual spreadsheet id
    ...
    #wk_sheet_stock = gc.open('U9426503_ib_data').sheet1
    ...
    if len(cells) < 2:
        ...
        gc.sheet.values_append(spreadsheet_id, stock_df_values, "ROWS", "U9426503_stock")
        gc.sheet.values_append(spreadsheet_id, currency_df_values, "ROWS", "U9426503_currency")
