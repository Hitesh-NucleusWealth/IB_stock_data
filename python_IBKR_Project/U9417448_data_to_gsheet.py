...
class TestApp(EWrapper, EClient):
    ...
    def start(self):
        ...
        self.reqAccountUpdates(True, "U9417448") # <----- Change account number here "U6084453"

    def stop(self):
        self.reqAccountUpdates(False,"U9417448") # <----- Change account number here "U6084453"
        self.done = True
        self.disconnect()
...
def main():
    ...
    # google sheet: Howard Hedge Fund Account spreadsheet ID
    spreadsheet_id = '1wRpKjwTwDoYLMYGTRLXG7_ItU5ozwJN4SGTZpIW_AKo' # consolidated spreadsheet ID

        #'1VQru8mb3qoV5l7MCN99QLoqWpl_7QfRshy--jo1Lff8' individual spreadsheet ID
    ...
    #wk_sheet_stock = gc.open('U9417448_ib_data').sheet1

    wk_sheet_stock = gc.open('Howard Hedge Fund Account').worksheet_by_title('U9426503_stock')
    ...
    if len(cells) < 2:
        ...
        gc.sheet.values_append(spreadsheet_id, stock_df_values, "ROWS", "U9417448_stock")
        gc.sheet.values_append(spreadsheet_id, currency_df_values, "ROWS", "U9417448_currency")
